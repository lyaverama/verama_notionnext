...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Vera Ma', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI Native Authority (AINA)方法论提出者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://verama.pro', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AINA, AI原生权威, AI Native Authority, AI时代个人品牌, Vera Ma', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是Vera Ma, AINA的提出者和实践者，欢迎来到我的博客🎉',
